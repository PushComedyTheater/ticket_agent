defmodule TicketAgentWeb.ExceptionSender do
  ...
  def message(:token_error),
    do: "There was an error receiving a token from our credit card processor."

  def message(:missing_stripe_customer_id),
    do: "There was an error with our payment process, please try again."
