defmodule TicketAgentWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TicketAgentWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TicketAgentWeb.Gettext, "errors", msg, opts)
    end
  end
