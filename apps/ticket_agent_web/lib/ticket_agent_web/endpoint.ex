defmodule TicketAgentWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :ticket_agent_web

  socket "/socket", TicketAgentWeb.UserSocket
  ...
  plug Plug.Static,
    at: "/", from: :ticket_agent_web, gzip: false,
