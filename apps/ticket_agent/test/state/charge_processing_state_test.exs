defmodule TicketAgent.State.ChargeProcessingStateTest do
  ...
  describe "set_order_processing_with_tickets" do
    ...
    test "does nothing for tickets that are not locked" do
      ...
      assert {:error, :ticket_processing_error} ==
               ChargeProcessingState.set_order_processing_with_tickets(order)
    end
    ...
    test "does nothing for orders that are not started" do
      ...
      assert {:error, :order_processing_error} ==
               ChargeProcessingState.set_order_processing_with_tickets(order)
    end
    ...
    test "works for orders that are started and tickets that are locked" do
      ...
      {:ok, {updated_order, [updated_ticket]}} =
        ChargeProcessingState.set_order_processing_with_tickets(order)
  ...
  describe "set_order_completed_with_tickets" do
    test "works for orders that are locked and tickets that are processing" do
      ...
      {:ok, {updated_order, [updated_ticket]}} =
        ChargeProcessingState.set_order_completed_with_tickets(order)
  ...
  describe "reset_order_and_tickets" do
    test "does nothing for tickets that are not processing" do
      ...
      assert {:error, :ticket_locked_error} ==
    ...
    test "does nothing for orders that are not started" do
      ...
      assert {:error, :order_starting_error} ==
               ChargeProcessingState.reset_order_and_tickets(order)
    end
