...
improv201 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293298/covers/qphl4uwhh5opshbsjuvl.png",
    menu_order: 2,
    account_id: account.id,
...
improv301 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293299/covers/uyjvypsmg96fcd4zl88j.png",
    menu_order: 3,
    account_id: account.id,
...
improv401 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293300/covers/vbstqyeecfovcwm3mx9r.png",
    menu_order: 4,
    account_id: account.id,
...
improv501 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293301/covers/hhlz9x5qcz2qqkk3xyga.png",
    menu_order: 5,
    account_id: account.id,
...
kidprov101 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293302/covers/g0upzsg4dchanai2ul0l.jpg",
    menu_order: 6,
    account_id: account.id,
    prerequisite_id: nil
  }
...
kidprov201 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293303/covers/orrcrhg9bcgnexgseitw.jpg",
    menu_order: 7,
    account_id: account.id,
...
music_improv101 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293304/covers/vggfmhm2c99mhkxi7r7v.jpg",
    menu_order: 8,
    account_id: account.id,
    prerequisite_id: improv101.id
  }
...
music_improv201 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293305/covers/rxu5yn34d5rp0nvnkssf.jpg",
    menu_order: 9,
    account_id: account.id,
...
music_improv_studio = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1508021107/covers/yes_yfvtxd.jpg",
    menu_order: 10,
    account_id: account.id,
...
teen_improv = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293306/covers/s9uyzugyefwu81hmicmb.jpg",
    menu_order: 11,
    account_id: account.id,
    prerequisite_id: nil
  }
...
sketch101 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293307/covers/nfshrdoaapy0pcsqayru.png",
    menu_order: 1,
    account_id: account.id,
    prerequisite_id: nil
  }
...
sketch201 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293308/covers/wk3zfokdjzhpxpfsrgxx.jpg",
    menu_order: 2,
    account_id: account.id,
...
standup101 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293309/covers/sxdcjtuvqwxkwyraic4x.jpg",
    menu_order: 1,
    account_id: account.id,
    prerequisite_id: nil
  }
...
acting101 = SeedHelpers.create_class(
  %{
    ...
    image_url: "https://res.cloudinary.com/push-comedy-theater/image/upload/v1507293310/covers/hgjkgz1oh1qqjrqznljt.png",
    menu_order: 1,
    account_id: account.id,
    prerequisite_id: nil
  }
